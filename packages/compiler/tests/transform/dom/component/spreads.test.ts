...
test('spread', () => {
  expect(dom('<Foo {...a}  />')).toMatchInlineSnapshot(`
    ...
    function $$_render_1({ $1, $2 }) {
        let $$_spread_props_1 = $1, $_component_1 = $$_create_component($2, $$_spread_props_1, $$_listen_callback($$_spread_props_1), null, host => {
...
test('multiple', () => {
  expect(dom('<Foo {...a} {...b} {...{a: 1, b: 2}} />')).toMatchInlineSnapshot(`
    ...
    function $$_render_1({ $1, $2, $3, $4 }) {
        let $$_spread_props_1 = $$_merge_props($1, $2, $3), $_component_1 = $$_create_component($4, $$_spread_props_1, $$_listen_callback($$_spread_props_1), null, host => {
            $$_host_spread(host, $$_spread_props_1);
        });
        return $_component_1;
    }
...
test('with attributes', () => {
  expect(
    ...
    function $$_render_1({ $1, $2, $3, $4, $5, $6 }) {
        let $$_spread_props_1 = $$_merge_props($1, $2), $_component_1 = $$_create_component($6, $$_spread_props_1, $$_listen_callback($$_spread_props_1, {
            "on:click": $5
        }), null, host => {
...
test('with props', () => {
  expect(dom('<Foo {...a} {...b} foo={10} bar={20}  />')).toMatchInlineSnapshot(`
    ...
    function $$_render_1({ $1, $2, $3 }) {
        let $$_spread_props_1 = $$_merge_props($1, $2, {
            "foo": 10,
            "bar": 20
        }), $_component_1 = $$_create_component($3, $$_spread_props_1, $$_listen_callback($$_spread_props_1), null, host => {
            $$_host_spread(host, $$_spread_props_1);
        });
        return $_component_1;
    }
